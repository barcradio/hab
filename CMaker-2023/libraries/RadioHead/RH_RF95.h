...
public:
    ...
    RH_RF95(uint8_t slaveSelectPin = SS, uint8_t interruptPin = 9, RHGenericSPI& spi = hardware_spi);
#elif defined(RFGATEWAY_M4)
    RH_RF95(uint8_t slaveSelectPin = SS, uint8_t interruptPin = 18, RHGenericSPI& spi = hardware_spi);
#else
